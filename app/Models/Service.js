...
class Service extends Model {
    ...
    avgRating() {
        return this.hasOne('App/Models/Review', 'id', 'service_id').select('service_id', Database.raw('(cast(AVG(rate) as decimal(10,2))) AS averageRating'), Database.raw('(cast(sum(rate) as decimal(10,2))) AS totalRating'))
    }
    // avgRating2() {
