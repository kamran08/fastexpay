            ...
            <div class="row " v-if="singleMember">
              ...
              <div class="col-12 col-md-8 col-lg-8">
                <div class="_team_main_details">
                  ...
                  <button class="_btn_gradient_default" type="button" @click="isAll=!isAll" v-scroll-to="(!isAll)?'#div1':''" v-if="singleMember.description.length>2500">
            ...
            <div class="row">
              ...
              <template v-else>
                <div class="_thank">
                  ...
                  <p
                    class="_booking_text"
                  >Thanks for contacting us! We will be in touch with you shortly.</p>
              ...
              <div class="col-12 col-md-12 col-lg-7">
                <div class="row">
                  ...
                  <div class="col-12 col-md-4 col-lg-4">
                    <p class="_cantact_sec_title">Opening Hours</p>
